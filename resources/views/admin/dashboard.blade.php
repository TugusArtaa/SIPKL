        ...
        <div class="grid grid-cols-3 gap-8">
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-gray-700 dark:text-slate-300 text-base font-medium">Total Mahasiswa</h3>
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-gray-700 dark:text-slate-300 text-base font-medium">Total Dosen</h3>
            ...
            <div
                ...
                <div class="relative z-10">
                    ...
                    <div class="space-y-2">
                        <h3 class="text-gray-700 dark:text-slate-300 text-base font-medium">Total Perusahaan</h3>
