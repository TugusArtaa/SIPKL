    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Form Edit Perusahaan</h3>
                    <p class="text-gray-500 dark:text-slate-400 text-sm mt-1">Perbarui data perusahaan sesuai kebutuhan
                    </p>
                </div>
            ...
            <form method="POST" action="{{ route('admin.perusahaan.update', $perusahaan) }}" class="space-y-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <h4 class="text-lg font-medium text-gray-900 dark:text-white">Data Perusahaan</h4>
                    </div>
