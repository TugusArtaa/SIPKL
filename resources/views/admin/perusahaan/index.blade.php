<x-app-layout>
    ...
    <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
        <div>
            <p class="text-gray-500 dark:text-slate-400 text-sm">Total keseluruhan perusahaan:
                {{ $perusahaan->total() }}
            </p>
        </div>
