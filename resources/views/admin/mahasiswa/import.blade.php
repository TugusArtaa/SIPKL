<x-app-layout>
    <div class="grid grid-cols-3 gap-8">
        ...
        <div class="col-span-2">
            <div
                class="bg-white dark:bg-white/[0.03] rounded-2xl border border-gray-200 dark:border-white/10 dark:shadow-2xl overflow-hidden">
                {{-- Form Header --}}
                <div
                        ...
                        <div class="space-y-6">
                            <div class="flex items-center space-x-3 mb-6">
                                <div class="p-2 bg-emerald-100 dark:bg-emerald-500/20 rounded-lg">
                                    <svg class="w-5 h-5 text-emerald-500 dark:text-emerald-300" fill="none"
                            ...
                            <div class="relative">
                                ...
                                <div id="file-drop-area"
                                    class="border-2 border-dashed border-gray-200 dark:border-white/30 rounded-2xl p-12 text-center hover:border-emerald-400/50 hover:bg-gray-50 dark:hover:bg-white/5 transition-all duration-300">
                                    <div class="space-y-4">
                                        <div class="flex justify-center">
                                            <div class="p-4 bg-emerald-100 dark:bg-emerald-500/20 rounded-2xl">
                                                <svg class="w-12 h-12 text-emerald-500 dark:text-emerald-300"
                                        ...
                                        <div id="file-info"
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <svg class="w-6 h-6 text-emerald-500 dark:text-emerald-300 flex-shrink-0"
                                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                                        d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                                                ...
                                                <button type="button"
                                                    class="ml-2 text-gray-500 dark:text-slate-400 hover:text-emerald-500 dark:hover:text-emerald-400 focus:outline-none"
        ...
        <div class="space-y-6">
            {{-- Template Download --}}
            <div
                class="bg-white dark:bg-white/[0.03] rounded-2xl border border-gray-200 dark:border-white/10 dark:shadow-xl p-6">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="flex items-start space-x-3">
                        <div
                            class="flex-shrink-0 w-6 h-6 bg-gray-100 dark:bg-white/10 rounded-full flex items-center justify-center text-xs text-gray-900 dark:text-white font-medium mt-0.5">
                            2</div>
                        <p class="text-gray-700 dark:text-slate-300">Isi data mahasiswa sesuai format template</p>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div
                            class="flex-shrink-0 w-6 h-6 bg-gray-100 dark:bg-white/10 rounded-full flex items-center justify-center text-xs text-gray-900 dark:text-white font-medium mt-0.5">
            ...
            <div
                ...
                <div class="space-y-2 text-sm">
                    ...
                    <div class="flex items-center space-x-2">
                        <div class="w-1.5 h-1.5 bg-red-400 rounded-full"></div>
                        <p class="text-gray-700 dark:text-slate-300">NIM harus unique</p>
                    </div>
                </div>
            </div>
        </div>
