    ...
    <div
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Form Edit Mahasiswa</h3>
                    <p class="text-gray-500 dark:text-slate-400 text-sm mt-1">Perbarui data mahasiswa sesuai kebutuhan
                    </p>
                </div>
        ...
        {{-- Form Body --}}
        <div class="p-8">
            <form method="POST" action="{{ route('admin.mahasiswa.update', $mahasiswa) }}" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    <div class="flex items-center space-x-3 mb-6">
                        ...
                        <h4 class="text-lg font-medium text-gray-900 dark:text-white">Data Mahasiswa</h4>
                    </div>
                    <div class="grid grid-cols-2 gap-6">
                        <div class="space-y-2 col-span-2">
                            ...
                            <div class="relative">
                                <x-text-input name="nama" id="nama" type="text" value="{{ $mahasiswa->nama }}"
                        ...
                        <div class="space-y-2 col-span-2">
                            <x-input-label for="nim" :value="'NIM *'"
                                class="text-gray-700 dark:text-slate-300 font-medium" />
                            <div class="relative">
                                <x-text-input name="nim" id="nim" type="text" value="{{ $mahasiswa->nim }}"
                                    class="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/20 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-400 focus:border-indigo-400/50 focus:bg-white/10 transition-all duration-200"
                        ...
                        <div class="space-y-2 col-span-2">
                            <x-input-label for="kelas" :value="'Kelas *'"
                                class="text-gray-700 dark:text-slate-300 font-medium" />
                            <div class="relative">
                                <x-text-input name="kelas" id="kelas" type="text" value="{{ $mahasiswa->kelas }}"
                                    class="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/20 rounded-xl px-4 py-3 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-slate-400 focus:border-indigo-400/50 focus:bg-white/10 transition-all duration-200"
                        ...
                        <div class="space-y-2 col-span-2">
                            <x-input-label for="semester" :value="'Semester *'"
                                class="text-gray-700 dark:text-slate-300 font-medium" />
                            <div class="relative">
                                <x-text-input name="semester" id="semester" type="number" min="1"
                ...
                <div class="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-white/10">
                    <div class="flex items-center space-x-2 text-gray-500 dark:text-slate-400">
                        ...
                        <span class="text-sm">Pastikan semua data sudah benar sebelum memperbarui mahasiswa</span>
                    </div>
