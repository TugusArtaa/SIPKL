<x-app-layout>
    ...
    <div class="mb-8 bg-white/[0.03] border border-white/10 rounded-2xl p-6 shadow-lg">
        <div class="flex items-center gap-4">
            <div>
                <h1 class="text-3xl font-bold text-white mb-2">Kelola Data Mahasiswa</h1>
                <p class="text-blue-100 text-sm">Lihat, tambah, dan kelola data mahasiswa pada Sistem Informasi PKL
    ...
    <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
        <div>
            <p class="text-slate-400 text-sm">Total keseluruhan mahasiswa: {{ $mahasiswa->total() }}</p>
        </div>
                ...
                <thead>
                    <tr class="border-b border-white/10 bg-slate-700/30">
                        <th
                            ...
                            No.</th>
                        <th
                            class="px-6 py-4 text-left text-xs font-semibold text-slate-300 uppercase tracking-wider w-36">
                            Nama</th>
                        <th
                            class="px-6 py-4 text-left text-xs font-semibold text-slate-300 uppercase tracking-wider w-32">
                            NIM</th>
                        <th
                            class="px-6 py-4 text-left text-xs font-semibold text-slate-300 uppercase tracking-wider w-32">
                            Program Studi</th>
                        <th
                            class="px-6 py-4 text-left text-xs font-semibold text-slate-300 uppercase tracking-wider w-14">
                            Kelas</th>
                        <th
                            class="px-6 py-4 text-center text-xs font-semibold text-slate-300 uppercase tracking-wider w-16">
                            Aksi</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-white/10">
                    ...
                    <tr class="hover:bg-white/5 transition-colors duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm font-semibold text-white max-w-[260px] truncate overflow-hidden">
                                {{ $mhs->nama }}
                            </div>
                        </td>
                        <td
                        ...
                        <td
                            class="px-6 py-4 whitespace-nowrap text-sm text-slate-300 max-w-[200px] truncate overflow-hidden">
                            {{ $mhs->program_studi }}
                        </td>
                        <td
                            class="px-6 py-4 whitespace-nowrap text-sm text-slate-300 max-w-[128px] truncate overflow-hidden">
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-slate-400 text-xl font-semibold mb-2">Belum ada data mahasiswa</p>
                                <p class="text-slate-500 text-sm">Mulai dengan menambah mahasiswa baru atau import data
                                </p>
                            </div>
                        </td>
                    </tr>
