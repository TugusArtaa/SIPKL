<x-app-layout>
    ...
    <div class="mb-8 bg-white/[0.03] border border-white/10 rounded-2xl p-6 shadow-lg">
        <div class="flex items-center gap-4">
            <div>
                <h1 class="text-3xl font-bold text-white mb-2">Kelola Data Dosen</h1>
                <p class="text-blue-100 text-sm">Lihat, tambah, dan kelola data dosen pada Sistem Informasi PKL
    ...
    <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
        <div>
            <p class="text-slate-400 text-sm">Total keseluruhan dosen: {{ $dosen->total() }}</p>
        </div>
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-slate-400 text-xl font-semibold mb-2">Belum ada data dosen</p>
                                <p class="text-slate-500 text-sm">Mulai dengan menambah dosen baru atau import data
                                </p>
                            </div>
                        </td>
                    </tr>
