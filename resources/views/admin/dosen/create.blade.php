    ...
    <div class="bg-white/[0.03] border border-white/10 rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-white/5 to-white/10 border-b border-white/10 px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    <h3 class="text-xl font-semibold text-white">Form Tambah Dosen</h3>
            ...
            <form action="{{ route('admin.dosen.store') }}" method="POST" class="space-y-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        ...
                        <div class="space-y-2">
                            <x-input-label for="nip" :value="'NIP *'" class="text-slate-300 font-medium" />
                            <div class="relative">
                                <x-text-input id="nip" name="nip" type="text"
                                    class="w-full bg-white/5 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-slate-400 focus:border-blue-400/50 focus:bg-white/10 transition-all duration-200"
                                    placeholder="Contoh: 197812312022" required />
                            </div>
                            <x-input-error :messages="$errors->get('nip')" class="text-red-400 text-sm" />
                        </div>
                        <div class="space-y-2 col-span-2">
                            <x-input-label for="email" :value="'Email Dosen *'" class="text-slate-300 font-medium" />
                            <div class="relative">
