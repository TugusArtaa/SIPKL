...
<div class="space-y-1">
    ...
    <!-- Dashboard -->
    <x-sidebar-link route="dosen.dashboard" label="Home" :collapsed="$collapsed" icon='<svg xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" stroke-linejoin="round" stroke-miterlimit="2" clip-rule="evenodd" viewBox="0 0 32 32" id="home">
