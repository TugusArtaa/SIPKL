                ...
                <div class="hidden md:grid md:grid-cols-12 gap-4 items-center px-6 py-4">
                    ...
                    <div class="col-span-2 text-center">
                        <a href="{{ asset('storage/' . $file->file) }}" target="_blank"
                            class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white text-sm font-medium rounded-lg transition-all duration-200 hover:scale-105 hover:shadow-lg">
