<x-app-layout>
    ...
    <div class="backdrop-blur-sm bg-white/[0.03] border border-white/10 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-white/10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-white">Template Laporan</h3>
                    <p class="text-sm text-slate-400">Daftar format laporan yang tersedia</p>
                </div>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
                ...
                <div class="hidden md:grid md:grid-cols-12 gap-4 items-center px-6 py-4">
                    ...
                    <div class="col-span-2 text-center">
                        <a href="{{ asset('storage/' . $file->file) }}" target="_blank"
                            class="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white text-sm font-medium rounded-lg transition-all duration-200 hover:scale-105 hover:shadow-lg">
            ...
            <div class="px-6 py-12 text-center">
                ...
                <h3 class="text-lg font-medium text-slate-300 mb-2">Belum Ada Format Laporan</h3>
    ...
    {{-- Help Section --}}
    <div class="mt-6 backdrop-blur-sm bg-white/[0.03] border border-white/10 rounded-2xl p-6 shadow-xl">
        <div class="flex items-start gap-4">
            <div
                class="flex-shrink-0 w-10 h-10 bg-gradient-to-r from-amber-500 to-orange-500 rounded-lg flex items-center justify-center">
                <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
            ...
            <div>
                <h4 class="text-lg font-semibold text-white mb-2">Panduan Penggunaan</h4>
