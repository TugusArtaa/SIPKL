<x-app-layout>
    <x-slot name="header">
        <h2 class="text-2xl font-semibold text-white">Upload Laporan PKL</h2>
    </x-slot>

    {{-- Header Section --}}
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-white mb-2">Upload Laporan PKL</h1>
        <p class="text-slate-400 text-sm">Silakan upload laporan Praktik Kerja Lapangan Anda dalam format PDF atau Word
        </p>
    </div>
                        ...
                        <div class="relative">
                            <input id="file" name="file" type="file" accept=".pdf,.doc,.docx" required
                                class="block w-full text-sm text-slate-300 bg-white/[0.05] backdrop-blur-sm border border-white/20 rounded-xl cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-200 hover:bg-white/[0.08]
                                                            file:mr-4 file:py-3 file:px-4 file:rounded-l-xl file:border-0 file:text-sm file:font-semibold file:bg-gradient-to-r file:from-emerald-600 file:to-teal-600 file:text-white file:cursor-pointer file:hover:from-blue-700 file:hover:to-cyan-700 file:transition-all file:duration-200" />
                        </div>
