    ...
    <div
        ...
        <div class="flex items-center gap-4">
            <div>
                ...
                <p class="text-gray-900 dark:text-blue-100 text-sm">Berikan penilaian Praktik Kerja Lapangan mahasiswa
                    bimbingan Anda.</p>
            </div>
        </div>
        <div class="mt-4">
    ...
    <div class="space-y-4">
        ...
        <div
            ...
            <div class="max-w-md mx-auto">
                ...
                <h3 class="text-xl font-semibold text-slate-700 dark:text-slate-300 mb-2">Tidak Ada Mahasiswa</h3>
